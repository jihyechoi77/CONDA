# reference: https://github.com/Wuyxin/DISC/blob/25717ffe3ae7eb74056a23936ccbfa4a84815535/disc/download_datasets.py
...
data_root = osp.join(ROOT, 'datasets')
os.makedirs(data_root, exist_ok=True)

# Download metashift
output = 'metashifts.zip'
url = 'https://drive.google.com/uc?export=downloadid=1WySOxBRkxAUlSokgZrC-0JaWZwcG5UMT'
...
# Download waterbirds
if not osp.exists(osp.join(data_root, 'waterbirds')):
    ...
    file.extractall(osp.join(data_root, 'waterbirds'))
    file.close()
